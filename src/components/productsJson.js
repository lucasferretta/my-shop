export const productos = [
    ...
    {   
        id: '4',
        name:'Cafiaspirina plus x 20 comp',
        grupo: 'Farmacia',
        stock: 9,
        accion: 'Analgésico',
    ...
    {   
        id: '6',
        name:'Sedal ceramidas x 190 ml - Shampoo',
        grupo: 'Perfumeria',
        stock: 3,
        accion: 'Shampoo',
    ...
    {   
        id: '7',
        name:'Sedal caída x 190 ml - Shampoo',
        grupo: 'Perfumeria',
        stock: 3,
        accion: 'Shampoo',
    ...
    {   
        id: '8',
        name:'Sedal restauración instantánea x 190 ml - Shampoo',
        grupo: 'Perfumeria',
        stock: 3,
        accion: 'Shampoo',
    ...
    {   
        id: '9',
        name:'Sedal ceramidas x 190 ml - Acondicionador',
        grupo: 'Perfumeria',
        stock: 3,
    ...
    {   
        id: '10',
        name:'Sedal liso perfecto x 190 ml - Acondicionador',
        grupo: 'Perfumeria',
        stock: 3,
        accion: 'Acondicionador',
    ...
    {   
        id: '11',
        name:'Sedal restauración instantánea x 190 ml - Acondicionador',
        grupo: 'Perfumeria',
        stock: 3,
        accion: 'Acondicionador',
    ...
    {   
        id: '12',
        name:'Sedal pureza detox x 190 ml - Acondicionador',
        grupo: 'Perfumeria',
        stock: 3,
        accion: 'Acondicionador',
